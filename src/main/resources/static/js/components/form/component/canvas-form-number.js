...
(function () {
    window.CanvasFormDesignerComponentRegistry.register({
        ...
        buildPreviewControlHtml: function (designer, field) {
            ...
            return "<div class=\"el-input\"><input class=\"el-input__inner\" type=\"number\" name=\"" + name + "\" placeholder=\"" + designer.escapeHtml(field.placeholder || "请输入") + "\" value=\"" + designer.escapeHtml(field.defaultValue || "") + "\"" + style + "></div>";
        }
    });
})();
