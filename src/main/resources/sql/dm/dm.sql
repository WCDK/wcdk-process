...
CREATE TABLE wcdk_process_definition (
    ...
    suspended               INT             NOT NULL DEFAULT 0, -- 是否挂起（0-正常 1-挂起）
...
CREATE TABLE wcdk_execution (
    ...
    is_scope                INT             NOT NULL DEFAULT 0, -- 是否为作用域（0-否 1-是）
    is_concurrent           INT             NOT NULL DEFAULT 0, -- 是否并发（0-否 1-是）
    is_event_scope          INT             NOT NULL DEFAULT 0, -- 是否为事件作用域（0-否 1-是）
    is_multi_instance       INT             NOT NULL DEFAULT 0, -- 是否多实例（0-否 1-是）
...
CREATE TABLE wcdk_variable (
    ...
    value_boolean           INT,                                -- 布尔型值（0-否 1-是）
    revision                BIGINT          NOT NULL DEFAULT 1, -- 乐观锁版本号
    created_at              TIMESTAMP       NOT NULL DEFAULT SYSDATE, -- 创建时间
    updated_at              TIMESTAMP       NOT NULL DEFAULT SYSDATE, -- 更新时间
...
-- 存储数据库Schema版本信息
-- -------------------------------------------
CREATE TABLE wcdk_schema_version (
    id                      BIGINT          NOT NULL,           -- 主键ID
    version                 VARCHAR(32)     NOT NULL,           -- 版本号
    description             VARCHAR(512),                       -- 描述
    applied_at              TIMESTAMP       NOT NULL DEFAULT SYSDATE, -- 应用时间
